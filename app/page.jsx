      ...
      {products.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
          {products.map(product => (
            <div key={product.id} className="group relative bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg border border-gray-200 hover:border-blue-500">
              <Link href={`/${type}/${product.id}`} className="block">
                ...
                <div className="p-4 bg-white">
                  ...
                  <p className="text-sm text-gray-600 font-bold mt-2">{product.price.toFixed(2)} CHF</p>
                </div>
              </Link>
              <button
